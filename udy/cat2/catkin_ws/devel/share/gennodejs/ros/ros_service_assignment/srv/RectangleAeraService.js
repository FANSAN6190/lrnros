...
class RectangleAeraServiceRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RectangleAeraServiceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RectangleAeraServiceRequest
    let len;
    let data = new RectangleAeraServiceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RectangleAeraServiceRequest(null);
...
class RectangleAeraServiceResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.are = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RectangleAeraServiceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RectangleAeraServiceResponse
    let len;
    let data = new RectangleAeraServiceResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_service_assignment/RectangleAeraServiceResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RectangleAeraServiceResponse(null);
...
module.exports = {
  Request: RectangleAeraServiceRequest,
  Response: RectangleAeraServiceResponse,
  md5sum() { return '0f9be5720fe9aa56c89660f4840144bc'; },
  datatype() { return 'ros_service_assignment/RectangleAeraService'; }
};
